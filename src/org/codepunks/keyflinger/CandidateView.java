...
public class CandidateView extends View
{
    ...
    public CandidateView(Context context)
    {
        ...
        mPaint.setTextSize(
            r.getDimensionPixelSize(R.dimen.candidate_font_height));
     ...
     * @param listener
     */
    public void setService(KeyFlinger listener)
    {
        mService = listener;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        setMeasuredDimension(measuredWidth, resolveSize(desiredHeight,
                                                        heightMeasureSpec));
    }
